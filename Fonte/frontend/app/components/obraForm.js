    ...
    return(
        <div>
            ...
            <div className="form-group">
                ...
                <input type="text" className="form-control" ref={contrato} defaultValue={obra.contrato}/>
            </div>

            <div className="form-group">
                <label>Planta</label>
                <input type="text" className="form-control" ref={planta} defaultValue={obra.planta}/>
            </div>
